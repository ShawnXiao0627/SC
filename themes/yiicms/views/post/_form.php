<link rel="stylesheet" href="<?php echo Yii::app()->theme->baseUrl . '/css/post/postform.css';?>" />
<link rel="stylesheet" href="<?php echo Yii::app()->theme->baseUrl . '/js/kindeditor/themes/default/default.css';?>" />
<script data-main="<?php echo Yii::app()->theme->baseUrl; ?>/js/index.js" data-start="controller/postform.controller,controller/post.controller" src="<?php echo Yii::app()->theme->baseUrl; ?>/js/lib/require.js"></script>

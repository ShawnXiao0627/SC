<script src="<?php echo Yii::app()->theme->baseUrl; ?>/js/lib/require.js"  data-main="<?php echo Yii::app()->theme->baseUrl; ?>/js/index.js" data-start="controller/menu.controller"></script>
<link rel="stylesheet" href="<?php echo Yii::app()->theme->baseUrl . '/css/menu/menuIndex.css';?>" />
<link rel="stylesheet" href="<?php echo Yii::app()->theme->baseUrl . '/css/menu/menubar.css';?>" />

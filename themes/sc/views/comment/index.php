<script data-main="<?php echo Yii::app()->theme->baseUrl; ?>/js/index.js" 
  data-start="controller/comment.controller" 
  src="<?php echo Yii::app()->theme->baseUrl; ?>/js/lib/require.js">
</script>
<link rel="stylesheet" href="<?php echo Yii::app()->theme->baseUrl . '/css/comment/commentmain.css';?>" />

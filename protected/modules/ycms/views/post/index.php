<script data-main="<?php echo $this->module->assetsUrl; ?>/js/index.js" data-start="controller/post.controller" src="<?php echo $this->module->assetsUrl;; ?>/js/lib/require.js"></script>

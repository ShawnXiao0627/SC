<link rel="stylesheet" href="<?php echo $this->module->assetsUrl . '/css/global/header.css';?>" />
...
<div class="sidebar-menu  bs-docs-sidenav affix-top">
    ...
    <ul id="home" class="nav nav-list collapse menu-second in">
      <li><a href="<?php echo Yii::app()->createUrl('ycms/site/index')?>"><i class="icon-home"></i> 首页</a></li>
    ...
    <ul id="articleMenu" class="nav nav-list collapse menu-second">
      <li><a href="<?php echo Yii::app()->createUrl('ycms/post/index')?>">
      <i class="icon-list-alt"></i> 所有文章</a></li>
      <li><a href="<?php echo Yii::app()->createUrl('ycms/post/create');?>"><i class="icon-pencil"></i> 写文章</a></li>
    ...
    <a href="<?php echo Yii::app()->createUrl('ycms/comment/index')?>" class="nav-header menu-first collapsed">
    ...
    <ul id="view" class="nav nav-list collapse menu-second">
      ...
      <li><a href="<?php echo Yii::app()->createUrl('ycms/menu/index')?>"><i class="icon-tasks"></i> 菜单</a></li>
